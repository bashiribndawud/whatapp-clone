...
export const getMessages = async (req, res, next) => {
  try {
    ...
    messages.forEach((message, index) => {
      //if message is not read and message is sent by another user
      //messages that was sent to me and i have not read
      if (
...
export const getInitailContactWithMessages = async (req, res, next) => {
  try {
